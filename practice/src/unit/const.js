...
export const speeds = [1562, 1250, 1000, 800, 640, 512, 410, 328, 262, 210, 167, 134, 107, 85, 68]

export const delays = [20, 30, 40, 50, 60, 70, 70, 80, 90, 90, 100, 110, 120 , 130, 140]
...
export const eachLines = 5 // 每消除eachLines行, 增加速度
